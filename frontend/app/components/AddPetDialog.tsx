  ...
  const onSubmit = async (data: PetFormData) => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/pets/add?id_usuario=${id_usuario}`,
        {
          method: "POST",
          headers: {
      ...
      setStatusDialog({
        ...
        type: "error",
        message:
          error instanceof Error ? error.message : "Error al registrar mascota",
      });
    } finally {
      setIsLoading(false);
    }
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Macho" className="hover:bg-primary/10">
                        Macho
                      </SelectItem>
                      <SelectItem
                        value="Hembra"
